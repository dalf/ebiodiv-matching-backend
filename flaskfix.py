...
# https://github.com/jarus/flask-testing/issues/143#issuecomment-687167825
import werkzeug
...
class ReverseProxyPathFix:
    ...
    def __init__(self, wsgi_app, base_url):
...
def patch_application(app, base_url):
    # patch app to handle non root url-s behind proxy & wsgi
    app.wsgi_app = ReverseProxyPathFix(ProxyFix(app.wsgi_app), base_url)
